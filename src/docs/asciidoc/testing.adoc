...
In the following example, Spring injects the `OrderServiceImpl` bean from the
...
In the following example, Spring injects the `OrderServiceImpl` from the `ApplicationContext`
