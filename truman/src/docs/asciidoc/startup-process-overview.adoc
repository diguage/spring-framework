...
plantuml::{includedir}/puml/org.springframework.beans.factory.config.BeanFactoryPostProcessor.puml[{diagram_attr}]

plantuml::{includedir}/puml/AbstractApplicationContext-obtainFreshBeanFactory.puml[{diagram_attr}]
...
plantuml::{includedir}/puml/AbstractApplicationContext-registerBeanPostProcessors.puml[{diagram_attr}]

plantuml::{includedir}/puml/read-xml.puml[{diagram_attr}]


.BeanFactoryPostProcessorOrderTest.java
[{java_src_attr}]
----
include::{truman_src_dir}/context/BeanFactoryPostProcessorFailTest.java[]
----

.BeanFactoryPostProcessorOrderTest.java
[{java_src_attr}]
----
include::{truman_src_dir}/context/BeanFactoryPostProcessorOkTest.java[]
----

.BeanFactoryPostProcessorOrderTest.java
[{java_src_attr}]
----
include::{truman_src_dir}/context/BeanFactoryPostProcessorOrderTest.java[]
----

目前， `BeanFactoryPostProcessor` 的排序和筛选，还不支持 `@Order(value = orderFactor)`，使用 `@Order` 会被当做没有设置排序因数来处理。
