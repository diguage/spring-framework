...
public class AspectAnnoArgsTest {
	public static final Logger logger = LoggerFactory.getLogger(AspectAnnoArgsTest.class);
	...
	public static class DiguageTask {
		public void run(Object param) {
			logger.info("Diguage.run executing.params[{}]", param);
		}
	}
	...
	public static class TypeAspect {
		@Pointcut("@args(com.diguage.truman.aop.AspectAnnoArgsTest.TypeAnnotation)")
		public void doType() {
		}
		...
		public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
			...
			try {
				...
				logger.info("TypeAspect executing. params[{}]", Arrays.toString(args));
			}
		}
	}
}
