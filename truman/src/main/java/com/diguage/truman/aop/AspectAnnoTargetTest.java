...
public class AspectAnnoTargetTest {
	public static final Logger logger = LoggerFactory.getLogger(AspectAnnoTargetTest.class);
	...
	public static class TypeAspect {
		@Pointcut("@target(com.diguage.truman.aop.AspectAnnoTargetTest.TypeAnnotation)")
		public void doType() {
		}
		...
		public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
			try {
				...
				logger.info("TypeAspect executing...");
			}
		}
	}
	...
	public static class MethodAspect {
		@Pointcut("@target(com.diguage.truman.aop.AspectAnnoTargetTest.MethodAnnotation)")
		...
		public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
			try {
				...
				logger.info("MethodAspect executing...");
			}
		}
	}
}
