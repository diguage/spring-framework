...
public class AspectWithinTest {
	public static final Logger logger = LoggerFactory.getLogger(AspectWithinTest.class);
	...
	public static class WithinTypeAspect {
		@Pointcut("@within(com.diguage.truman.aop.AspectWithinTest.WithinTypeAnnotation)")
		...
		public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
			try {
				...
				logger.info("WithinTypeAspect executing...");
			}
		}
	}
	...
	public static class WithinMethodAspect {
		@Pointcut("@within(com.diguage.truman.aop.AspectWithinTest.WithinMethodAnnotation)")
