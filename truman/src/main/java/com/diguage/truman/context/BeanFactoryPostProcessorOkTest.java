 ...
 */
public class BeanFactoryPostProcessorOkTest {
  private static final Logger logger = LoggerFactory.getLogger(BeanFactoryPostProcessorOkTest.class);
  ...
  @Import({EmployeesService.class, PropertySourcesFactoryPostProcessor.class})
  ...
  public static class LoggerBeanFactoryPostProcessor implements BeanFactoryPostProcessor, EnvironmentAware, PriorityOrdered {

    private Environment environment;

    @Override
    public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
      String userToken = this.environment.getProperty("user.token", String.class, "defaultToken");
